...
function init(window, document) {require('../../common/vendors~index~log.js')(window, document);require('../../common/vendors~index.js')(window, document);require('../../common/index.js')(window, document)}
